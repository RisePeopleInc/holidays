...
module Holidays
  ...
  module NORTH_AMERICA # :nodoc:
    def self.defined_regions
      [:ca, :ca_bank_holidays, :ca_ab, :ca_sk, :ca_on, :ca_bc, :ca_mb, :ca_ns, :ca_pe, :ca_yt, :ca_nt, :ca_nl, :ca_nu, :ca_nb, :ca_yk, :ca_qc, :mx, :mx_pue, :us, :us_dc, :us_ca]
    end

    def self.holidays_by_month
      {
              0 => [{:function => "easter(year)", :function_arguments => [:year], :function_modifier => -2, :name => "Good Friday", :regions => [:ca, :ca_bank_holidays]},
      ...
      1 => [{:mday => 1, :name => "New Year's Day", :regions => [:ca, :ca_bank_holidays]},
      ...
      5 => [{:function => "ca_victoria_day(year)", :function_arguments => [:year], :name => "Victoria Day", :regions => [:ca_ab, :ca_sk, :ca_on, :ca_bc, :ca_mb, :ca_pe, :ca_yt, :ca_nt, :ca_nl, :ca_nu, :ca_nb, :ca_yk, :ca_bank_holidays]},
      ...
      6 => [{:mday => 24, :observed => "to_monday_if_sunday(date)", :observed_arguments => [:date], :name => "Fête Nationale", :regions => [:ca_qc]},
            ...
            {:mday => 23, :name => "National Indigenous People's Day", :regions => [:ca_yk, :ca_yt]},
      ...
      10 => [{:wday => 1, :week => 2, :name => "Thanksgiving", :regions => [:ca_ab, :ca_sk, :ca_on, :ca_bc, :ca_mb, :ca_pe, :ca_yt, :ca_nt, :ca_nl, :ca_nu, :ca_nb, :ca_yk, :ca_qc, :ca_bank_holidays]},
      ...
      12 => [{:mday => 25, :name => "Christmas Day", :regions => [:ca, :ca_bank_holidays]},
            {:mday => 26, :name => "Boxing Day", :regions => [:ca_on, :ca_bank_holidays]},
